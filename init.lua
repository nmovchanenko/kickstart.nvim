...
vim.keymap.set('n', '<C-d>', '<C-d>zz') -- to centre on scroll down
vim.keymap.set('n', '<C-u>', '<C-u>zz') -- to centre on scroll up
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        --
        defaults = {
          -- specific patterns to ignore, even when 'hidden' is enabled
